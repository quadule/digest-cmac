...
class CMACTest < Test::Unit::TestCase
  def setup
    ...
    @cipher.iv = "\000"*16
    @cmac = Digest::CMAC.new(@cipher, "2b7e151628aed2a6abf7158809cf4f3c".hex_to_raw)
  end
  ...
  def test_32_bytes_chunked
    @cmac.update('6bc1be'.hex_to_raw)
    @cmac.update('e22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e'.hex_to_raw)
    @cmac.update('51'.hex_to_raw)
    assert_equal @cmac.digest.unpack('H*')[0], 'ce0cbf1738f4df6428b1d93bf12081c9'
  end
  
  def test_40_bytes
    @cmac.update('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411'.hex_to_raw)
    assert_equal @cmac.digest.unpack('H*')[0], 'dfa66747de9ae63030ca32611497c827'
  end
  
  def test_64_bytes
    @cmac.update('6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411e5fbc1191a0a52eff69f2445df4f9b17ad2b417be66c3710'.hex_to_raw)
